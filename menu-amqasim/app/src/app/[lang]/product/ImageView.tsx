      ...
      >
         <div className="p-6 space-y-4">
            ...
            <div className="border-b pb-4">
               ...
               {product.description && (
                  <p className="text-[color-mix(in_srgb,var(--text-color)_70%,var(--bg-color))] text-sm mt-1">
                     {product.description}
                  </p>
               )}
...
function ImageView() {
   ...
   if (error) {
      return (
         <div className="product-image-view">
            <div className="product-image-error text-center py-12">
                           ...
                           <div className="product-content">
                              ...
                              <div className="flex gap-3 items-start">
                                 <div className="view-details-hint">
                                    <Eye className="view-details-icon hidden md:inline-block" />
                                    <span>{dict.products.view_details}</span>
                                    {lang === "ar" ? (
                                       <ArrowLeft className="view-details-icon" />
                                    ) : (
                                 ...
                                 {!isAdmin &&
                                    ...
                                    product.addons.length > 0 && (
                                       ...
                                       >
                                          <Plus className="addon-select-icon" />
                                          <span>
                                             {
                                                dict.products
